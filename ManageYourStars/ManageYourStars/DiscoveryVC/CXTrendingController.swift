...
class CXTrendingController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        control.addTarget(self, action: #selector(CXTrendingController.controlValueChanged(control:)), for: .valueChanged)
